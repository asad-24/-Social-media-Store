...
router.push('/CreateNewPassword')
  ...
  return (
   ...
   <Image src={verificationLogo} alt="logo" className="w-[45%]"/>
       ...
       <div className="z-10">
       <h1 className="text-white text-3xl my-6">Verify Phone Number</h1>
         <p className="text-white text-md w-[80%]" >Enter the 5 digit code received on your  phone number.</p>
         <div className="my-5">
